...
public class KettleBlock extends HorizontalFacingBlock implements IWaterLoggable {
...
this.setDefaultState(this.stateManager.any().setValue(FACING, Direction.NORTH).setValue(SUPPORT, CookingPotSupport.NONE).setValue(WATERLOGGED, false).setValue(WATER_LEVEL, 0).setValue(LID, true));
}
