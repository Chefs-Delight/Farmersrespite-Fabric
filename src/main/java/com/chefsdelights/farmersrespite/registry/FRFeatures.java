...
public class FRFeatures {
	...
	public static final class Configured {
		public static final ConfiguredFeature<?, ?> WILD_TEA_BUSH_FEATURE = register("wild_tea_bush", FRFeatures.WILD_TEA_BUSH.configured(FeatureConfig.DEFAULT)
				.decorated(ConfiguredFeatures.Placements.HEIGHTMAP_DOUBLE_SQUARE).chance(18).count(3));
		public static final ConfiguredFeature<?, ?> COFFEE_BUSH_FEATURE = register("coffee_bush", FRFeatures.COFFEE_BUSH.configured(FeatureConfig.DEFAULT)
				.decorated(ConfiguredFeatures.Placements.HEIGHTMAP_DOUBLE_SQUARE).count(50));
