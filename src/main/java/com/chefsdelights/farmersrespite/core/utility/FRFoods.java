...
//	public static final FoodProperties COFFEE_BERRIES = (new FoodProperties.Builder()).nutrition(2).saturationMod(0.4f).effect( new MobEffectInstance(MobEffects.WITHER, 100, 0), 0.8F).effect( new MobEffectInstance(FREffects.CAFFEINATED, 200, 0), 1.0F).build();
	...
	// Bowl Foods
//	public static final FoodProperties BLACK_COD = (new FoodProperties.Builder()).nutrition(10).saturationMod(0.9f).effect( new MobEffectInstance(EffectsRegistry.NOURISHMENT, 3600, 0), 1.0F).effect( new MobEffectInstance(FREffects.CAFFEINATED, 600, 0), 1.0F).build();
